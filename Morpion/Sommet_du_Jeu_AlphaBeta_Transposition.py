...
class SommetDuJeuAlphaBetaTransposition:
    __vertices_created = 0
    __transposion_table = {}
    def __init__(self, is_ami=True):
        SommetDuJeuAlphaBetaTransposition.__vertices_created += 1
        self._children = list()
        self._alpha = None
        self._beta = None
        self._score = None
    ...
    def children(self):
        ...
        # Si la liste est vide alors on la recalcule
            ...
            for move in self.map.next_possible_moves():
                ...
                new_child_vertice = SommetDuJeuAlphaBetaTransposition(next_ami)  # Je dois avoir des fils de la même classe
    ...
    def alpha(self):
        ...
        if self.map.game_over():
            ...
            for move in self.map.next_possible_moves():
                ...
                # Création du sommet fils
                new_child_vertice = SommetDuJeuAlphaBetaTransposition(not self.is_ami)  # Je dois avoir des fils de la même classe
...
if __name__ == "__main__":
    ...
    sommet = SommetDuJeuAlphaBetaTransposition()
    ...
    while not sommet.map.game_over():
        ...
        sommet = SommetDuJeuAlphaBetaTransposition(is_ami=not sommet.is_ami)
    ...
    print("{} sommets ont été créés pour les besoins de cette simulation.".format(
        SommetDuJeuAlphaBetaTransposition.nb_vertices_created()))
